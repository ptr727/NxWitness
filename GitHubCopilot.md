...
- The primary entry points are VS Code launch configurations that run CreateMatrix commands to generate versions, matrix data, schemas, and Docker/compose files.
...
- Respect line endings and encoding rules from the repository configuration.
