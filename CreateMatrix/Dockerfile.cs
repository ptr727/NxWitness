...
internal static class DockerFile
{
    ...
    )
    {
        ...
        foreach (ProductInfo.ProductType productType in ProductInfo.GetProductTypes())
        {
            ...
            WriteDockerfile(filePath, dockerFile);
    ...
    private static void WriteDockerfile(string filePath, string dockerFile)
    {
        Log.Logger.Information("Writing Dockerfile to {Path}", filePath);
        File.WriteAllText(filePath, dockerFile.ReplaceLineEndings("\n").TrimEnd('\n') + "\n");
    }
    ...
    private static void CreateBaseDockerfiles(string dockerPath)
    {
        ...
        WriteDockerfile(baseFilePath, baseDockerfile);
        ...
        WriteDockerfile(baseLsioFilePath, baseLsioDockerfile);
    }
